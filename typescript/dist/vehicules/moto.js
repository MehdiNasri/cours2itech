...
var Moto = /** @class */ (function (_super) {
    ...
    function Moto(marque, couleur, prix, moteur) {
        ...
        _this.displayMoto = function () {
            console.log("Je suis une Moto , ma marque est : " + _this.get_marque() + " ma couleur est : " + _this.get_couleur() + " je coute : " + _this.get_prix() + "€ j'utilise un moteur : " + _this.moteur.get_type());
        };
        return _this;
    }
    return Moto;
